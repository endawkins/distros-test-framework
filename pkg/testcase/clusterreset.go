...
func TestClusterReset() {
	...
	shared.LogLevel("info", "cluster reset successful. Waiting 60 seconds for cluster to complete background processes after reset.")
	...
	startServer(cluster)
	shared.LogLevel("info", "%s-service started. Waiting 60 seconds for nodes and pods to sync after reset.", cluster.Config.Product)
